import{v as m,g as a}from"./index-c6057a12.js";const y=n=>new Promise(t=>setTimeout(t,n));class w{async generateText(t,r){return console.log("使用模拟AI服务生成文本，避免API调用..."),await y(1e3),t.includes("基于以下健康数据生成个性化饮食计划")?`这是一份为您定制的饮食计划：
